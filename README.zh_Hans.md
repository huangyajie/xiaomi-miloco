...
- **[2026-02] v0.1.7 发布**：新增 Rockchip MPP+RGA 硬件加速，用于摄像头解码。
- **[2026-01] v0.1.6 发布**：新增米家摄像头清晰度配置，并启用 RTSP 音频传输。
- **[2026-01] v0.1.5 发布**：支持 Home Assistant 设备作为自动化规则的触发源。
- **[2025-12] v0.1.4 发布**：增加对 Home Assistant (HA) 设备的全面支持。
- **[2025-12] v0.1.3 发布**：
  - 支持集成第三方 RTSP 摄像头。
  - 为小米摄像头提供 RTSP 服务能力。
